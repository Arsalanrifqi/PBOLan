...
public class LayoutAWT extends Frame implements WindowListener{
	String nim;
	String nama;
	String jk;
	String alamat;
...
public boolean action(Event e, Object what){
	if(what.equals("save")){
		...
		new LayoutAWT(nim, nama, jk, alamat, tmp_lahir, tgl_lahir);
...
public LayoutAWT(String nim,String nama,String jk,String alamat,String tmp_lahir,
		String tgl_lahir){
